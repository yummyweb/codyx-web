...
import { idlFactory } from './codyx_icp.did.js';
export { idlFactory } from './codyx_icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CODYX_ICP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./codyx_icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the codyx_icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./codyx_icp.did.js")._SERVICE>}
 */
export const codyx_icp = createActor(canisterId);
