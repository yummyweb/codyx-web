...
async fn _cdk_user_defined_get_user(_cdk_user_defined_id: candid::Int) -> (Option<User>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
...
#[ic_cdk_macros::query(name = "get_app")]
#[candid::candid_method(query, rename = "get_app")]
async fn _cdk_user_defined_get_app(_cdk_user_defined_id: candid::Int) -> (Option<App>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_app", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_states_from_app_id")]
#[candid::candid_method(query, rename = "get_states_from_app_id")]
async fn _cdk_user_defined_get_states_from_app_id(
    ...
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_states_from_app_id", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_objects_from_app_id")]
#[candid::candid_method(query, rename = "get_objects_from_app_id")]
async fn _cdk_user_defined_get_objects_from_app_id(
    _cdk_user_defined_id: candid::Int,
) -> (Option<Vec<Object>>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_objects_from_app_id", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_fields_from_obj_id")]
#[candid::candid_method(query, rename = "get_fields_from_obj_id")]
async fn _cdk_user_defined_get_fields_from_obj_id(
    _cdk_user_defined_id: candid::Int,
) -> (Option<Vec<Field>>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_fields_from_obj_id", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_actions_from_app_id")]
#[candid::candid_method(query, rename = "get_actions_from_app_id")]
async fn _cdk_user_defined_get_actions_from_app_id(
    _cdk_user_defined_id: candid::Int,
) -> (Option<Vec<Action>>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_actions_from_app_id", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "new_user")]
#[candid::candid_method(update, rename = "new_user")]
async fn _cdk_user_defined_new_user() -> (candid::Int) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = ();
    call_global_python_function("new_user", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_app")]
#[candid::candid_method(update, rename = "create_app")]
async fn _cdk_user_defined_create_app(
    _cdk_user_defined_creator: candid::Int,
    ...
    call_global_python_function("create_app", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_state")]
#[candid::candid_method(update, rename = "create_state")]
async fn _cdk_user_defined_create_state(
    _cdk_user_defined_name: String,
    _cdk_user_defined_obj_id: candid::Int,
    _cdk_user_defined_app_id: candid::Int,
) -> () {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (
        _cdk_user_defined_name
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
        _cdk_user_defined_obj_id
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
        _cdk_user_defined_app_id
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
    );
    call_global_python_function("create_state", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_object")]
#[candid::candid_method(update, rename = "create_object")]
async fn _cdk_user_defined_create_object(
    _cdk_user_defined_name: String,
    _cdk_user_defined_app_id: candid::Int,
) -> (Option<candid::Int>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
    ...
    call_global_python_function("create_object", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_field")]
#[candid::candid_method(update, rename = "create_field")]
async fn _cdk_user_defined_create_field(
    _cdk_user_defined_name: String,
    _cdk_user_defined_type: String,
    _cdk_user_defined_obj_id: candid::Int,
) -> () {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    ...
    call_global_python_function("create_field", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_action")]
#[candid::candid_method(update, rename = "create_action")]
async fn _cdk_user_defined_create_action(
    _cdk_user_defined_name: String,
    _cdk_user_defined_type: String,
    _cdk_user_defined_obj_id: candid::Int,
    _cdk_user_defined_app_id: candid::Int,
    ...
    call_global_python_function("create_action", params)
        .await
        .unwrap_or_trap()
}
#[derive(
...
struct Action {
    id: Box<i8>,
    action_name: Box<String>,
    action_type: Box<String>,
    action_obj: Box<Object>,
}
#[derive(
    serde :: Deserialize,
    Debug,
...
struct Field {
    id: Box<i8>,
    field_name: Box<String>,
    field_type: Box<String>,
}
#[derive(
    serde :: Deserialize,
    Debug,
...
struct State {
    id: Box<i8>,
    state_name: Box<String>,
    state_type: Box<Object>,
    state_app: Box<App>,
}
#[derive(
    serde :: Deserialize,
...
struct App {
    id: Box<i8>,
    app_creator: Box<User>,
    app_name: Box<String>,
    app_state: Box<Vec<i8>>,
    app_objects: Box<Vec<i8>>,
    app_actions: Box<Vec<i8>>,
}
#[derive(
    serde :: Deserialize,
    Debug,
...
struct User {
    id: Box<i8>,
    user_apps: Box<Vec<i8>>,
    user_username: Box<String>,
}
#[derive(
    serde :: Deserialize,
    Debug,
